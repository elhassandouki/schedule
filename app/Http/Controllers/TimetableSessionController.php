...
use App\Models\{Classroom, Program, SchoolDay, Semester, Subject, Teacher, Timeslot, TimetableSession, StudentGroup};
...
class TimetableSessionController extends Controller
{
    ...
    {
        $sessions = TimetableSession::with(['subject', 'teacher', 'classroom', 'studentGroup', 'timeslot', 'day'])
